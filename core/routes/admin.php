...
Route::middleware(['admin',  'trackUser'])->withoutMiddleware([LanguageMiddleware::class])->group(function () {
    ...
    Route::controller('AdminController')->group(function () {
        ...
        Route::get('fee', 'togleFee')->name('togleFee');
        Route::post('feesave', 'feeSave')->name('fee.save');
        Route::get('managelots', 'managelots')->name('managelots');
        Route::post('managelots', 'savelots')->name('savelots');
        Route::post('lot/{id}/delete', 'deletelot')->name('lot.delete');
