        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" role="tabpanel">
                <div class="order-wrapper">
                    <x-flexible-view :view="$activeTemplate . 'trade.buy_form'"  :meta="['pair' => $pair,'marketCurrencyWallet' => $marketCurrencyWallet,'screen' => 'big', 'order_count' => $order_count, 'lots' => $lots, 'fee_status' => $fee_status, 'view_portfolio' => $view_portfolio]" />
...
@else
    ...
    <div class="col-sm-12">
        <div class="d-sm-block d-md-none">
            <x-flexible-view :view="$activeTemplate . 'trade.buy_form'"  :meta="['pair' => $pair,'marketCurrencyWallet' => $marketCurrencyWallet,'screen' => 'small', 'order_count' => $order_count, 'lots' => $lots, 'fee_status' => $fee_status]" />
                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            if (resp.success) {
                                ...
                                if ($('#modalBuySell').length > 0) {
                                    $('#modalBuySell').modal('hide');
                                 
                                    $('[data-bs-target="#order-book-sm"]').tab('show');
