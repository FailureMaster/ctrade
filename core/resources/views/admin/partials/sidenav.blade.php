            ...
            <ul class="sidebar__menu">
                ...
                @if(can_access('manage_admins'))
                    <li class="sidebar-menu-item sidebar-dropdown">
                        <a href="javascript:void(0)" class="{{ menuActive(['admin.manage_admins.admins', 'admin.manage_admins.another_route*'], 3) }}">
                            <i class="menu-icon las la-file-invoice-dollar"></i>
                            <span class="menu-title">@lang('Workers')</span>
                        </a>
                        <div class="sidebar-submenu {{ menuActive(['admin.manage_admins.admins', 'admin.manage_admins.another_route*'], 2) }}">
                            <ul>
...
'admin.users.notification.all'],2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.banned')}} ">
                                <a href="{{route('admin.users.banned', ['filter' => 'all_time'])}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item  {{menuActive('admin.users.email.unverified')}}">
                                <a href="{{route('admin.users.email.unverified', ['filter' => 'all_time'])}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.mobile.unverified')}}">
                                <a href="{{route('admin.users.mobile.unverified', ['filter' => 'all_time'])}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.kyc.unverified')}}">
                                <a href="{{route('admin.users.kyc.unverified', ['filter' => 'all_time'])}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.kyc.pending')}}">
                                <a href="{{route('admin.users.kyc.pending', ['filter' => 'all_time'])}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
