...
@section('panel')
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <a class="fas fa-sort" href="{{ $url }}"
                                            style="color: #fff; margin-left: 6px;"></a>
                                    </th>
                                ...
                                @forelse($users as $user)
                                    <tr>
                                        <td class="text-center">
                                            <input type="checkbox" class="form-check-input selectUser"
                                                id="flexCheckDefault{{ $user->id }}" name="selectUsers[]"
                                                value="{{ $user->id }}">
                                        </td>
                                        <!--<td>-->
    ...
    @endif-->
                                        ...
                                        <td>
                                            @if (can_access('change-user-type'))
                                                <form id="userTypeForm"
                                                    ...
                                                    method="POST">
                                                    @csrf
                                                    <button type="button" class="btn-ac"
                                        ...
                                        <td>
                                            ...
                                            <img src="https://flagcdn.com/24x18/{{ Illuminate\Support\Str::lower($user->country_code) }}.png"
                                                width="12" height="12">
                                        </td>
                                        <td>
                                            <form id="editStatusFormInline"
                                                action="/admin/users/update-status/{{ $user->id }}" method="post"
                                                class="m-0">
                                                @csrf
                                                <div>
                                                    <select class="form-select" name="status" id="userStatusInline"
                                                        value="{{ $user->sales_status }}" onchange="this.form.submit()"
                                        ...
                                        @if (can_access('manage-sales-leads|manage-retention-leads'))
                                            <td>
                                                <form id="editOwnerFormInline"
                                                    action="/admin/users/update-owner/{{ $user->id }}" method="post"
                                                    class="m-0">
                                                    @csrf
                                                    <div>
                                                        <!-- <label for="userOwner" class="col-form-label">Owner:</label> -->
                                                        <select class="form-select" name="owner" id="userOwnerInline"
                                            ...
                                            <div class="">
                                                @if (can_access('delete-user'))
                                                    <button type="button" class="btn btn-outline--primary"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-placement="top" title="Delete">
                                                ...
                                                @php
                                                    if (
                                                        ...
                                                        $commentvar =
                                                            $user->comments->last()->comment .
                                                            '-' .
                                                            (isset($user->comments->last()->commentor->name)
                                                                ? $user->comments->last()->commentor->name
                                                                : 'User Deleted');
                                                    } else {
                                                ...
                                                <a href="{{ route('admin.users.detail', $user->id) . ($history == 'clients' ? '?back=clients' : '?back=leads') }}"
                                                    class="btn btn-sm btn-outline--primary" data-bs-placement="top"
                                                    title="More Info">
                                        ...
                                        <div id="actionMessageModal{{ $user->id }}" class="modal fade"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('admin.users.delete', $user->id) }}"
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn--primary">@lang('Yes')</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
